...
Promise.all([
  ...
  if(thumbsEl && thumbCfg.length){
    ...
    thumbCfg.forEach(function(tc){
      ...
      var lbl=txt.label||'';
      if(tc.style==='lines'){
        prevHtml='<div class="th-prev inv-p"></div>';
      } else if(tc.style==='bars'){
        prevHtml='<div class="th-prev dash-p"></div>';
      } else if(tc.style==='skew'){
        prevHtml='<div class="th-prev camp-p"></div>';
      } else if(tc.style==='gradient'){
        prevHtml='<div class="th-prev" style="background:linear-gradient(140deg,#EAF4FC,#D4EAF8);position:relative"><div style="position:absolute;top:8px;left:8px;font-family:var(--mono);font-size:7px;letter-spacing:.1em;text-transform:uppercase;color:rgba(11,28,51,0.4)">'+lbl+'</div><div style="position:absolute;bottom:8px;left:8px;right:8px;height:2px;background:linear-gradient(to right,#6D28D9,#047857,#BE185D,#C2410C,#B45309);border-radius:1px"></div></div>';
      } else if(tc.style==='draft'){
        prevHtml='<div class="th-prev" style="position:relative"><div style="position:absolute;top:7px;left:8px;right:8px;display:flex;flex-direction:column;gap:4px"><div style="height:2px;background:rgba(11,28,51,0.08);border-radius:1px;width:70%"></div><div style="height:2px;background:rgba(11,28,51,0.06);border-radius:1px;width:55%"></div><div style="height:2px;background:rgba(11,28,51,0.04);border-radius:1px;width:40%"></div></div><div style="position:absolute;bottom:7px;right:8px;font-family:var(--mono);font-size:6px;letter-spacing:.08em;text-transform:uppercase;color:rgba(212,135,10,.5)">'+lbl+'</div></div>';
